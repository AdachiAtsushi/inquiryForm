...
public class InquiryDaoImpl implements InquiryDao {
	...
	public void insertInquiry(Inquiry inquiry) {
		this.jdbcTemplate.update("INSERT INTO inquiry(name, email, contents, created) VALUES(?, ?, ?, ?)", 
	...
	public int updateInquiry(Inquiry inquiry) {
		return this.jdbcTemplate.update("UPDATE inquiry SET name = ?, email = ?, contents = ? WHERE id = ?", 
